...
public class TC4Interop{
	...
	private static void initTCAspects(){
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_BLUE_TOPAZ_ORE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.ENERGY, 2).add(Aspect.CRYSTAL, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_BLUE_TOPAZ_BLOCK), new AspectList().add(Aspect.ENERGY, 9).add(Aspect.CRYSTAL, 9));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_SUNSTONE_ORE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.FIRE, 6).add(Aspect.CRYSTAL, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_SUNSTONE_BLOCK), new AspectList().add(Aspect.FIRE, 5).add(Aspect.CRYSTAL, 10));
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_MOONSTONE_ORE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.ELDRITCH, 2).add(Aspect.MAGIC, 2).add(Aspect.VOID, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_MOONSTONE_BLOCK), new AspectList().add(Aspect.ELDRITCH, 9).add(Aspect.MAGIC, 9).add(Aspect.VOID, 9));
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_CHIMERITE_ORE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.SENSES, 6).add(Aspect.EXCHANGE, 3));
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_CHIMERITE_BLOCK), new AspectList().add(Aspect.SENSES, 5).add(Aspect.EXCHANGE, 9));
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_VINTEUM_ORE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(BlocksCommonProxy.AMOres, 1, BlockAMOre.META_VINTEUM_BLOCK), new AspectList().add(Aspect.MAGIC, 2));
		...
		//items
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_BLUETOPAZ), new AspectList().add(Aspect.ENERGY, 1).add(Aspect.CRYSTAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_SUNSTONE), new AspectList().add(Aspect.FIRE, 3).add(Aspect.CRYSTAL, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_MOONSTONE), new AspectList().add(Aspect.ELDRITCH, 1).add(Aspect.MAGIC, 1).add(Aspect.VOID, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_CHIMERITE), new AspectList().add(Aspect.SENSES, 3).add(Aspect.EXCHANGE, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_VINTEUMDUST), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.ENTROPY, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_ARCANECOMPOUND), new AspectList().add(Aspect.MAGIC, 3));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_ARCANEASH), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.FIRE, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_PURIFIEDVINTEUM), new AspectList().add(Aspect.MAGIC, 6).add(Aspect.ENTROPY, 1).add(Aspect.ORDER, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_COSMICDUST), new AspectList().add(Aspect.ELDRITCH, 1).add(Aspect.VOID, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_CELESTIALFISH), new AspectList().add(Aspect.ELDRITCH, 3).add(Aspect.ENERGY, 5));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_HELLFISH), new AspectList().add(Aspect.FIRE, 5).add(Aspect.MAGIC, 2).add(Aspect.ENERGY, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_PYROGENICSEDIMENT), new AspectList().add(Aspect.FIRE, 3).add(Aspect.EARTH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_SPATIALSTAR), new AspectList().add(Aspect.MAGIC, 10).add(Aspect.VOID, 5).add(Aspect.TRAVEL, 5).add(Aspect.ELDRITCH, 4).add(Aspect.ENERGY, 3));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_TEMPORALCLUSTER), new AspectList().add(Aspect.MAGIC, 15).add(Aspect.EXCHANGE, 25).add(Aspect.ENERGY, 25).add(Aspect.SOUL, 10));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_COGNITIVEDUST), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.SOUL, 1).add(Aspect.EARTH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_FRACTALFRAGMENT), new AspectList().add(Aspect.MAGIC, 5).add(Aspect.ENTROPY, 10).add(Aspect.ORDER, 10));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_SOULFRAGMENT), new AspectList().add(Aspect.ENERGY, 15).add(Aspect.SOUL, 5));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_SUNSTONEFRAGMENT), new AspectList().add(Aspect.FIRE, 2).add(Aspect.CRYSTAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_MOONSTONEFRAGMENT), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.VOID, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_NIGHTMAREESSENCE), new AspectList().add(Aspect.VOID, 3).add(Aspect.ENTROPY, 3).add(Aspect.AURA, 3));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_ANIMALFAT), new AspectList().add(Aspect.BEAST, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_STORMSAWTOOTH), new AspectList().add(Aspect.WEATHER, 8).add(Aspect.MAGIC, 5).add(Aspect.AIR, 5).add(Aspect.FIRE, 5));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_RAINROCKROSE), new AspectList().add(Aspect.MAGIC, 5).add(Aspect.WEATHER, 3).add(Aspect.WATER, 3));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_IMBUEDMOONFLOWER), new AspectList().add(Aspect.MAGIC, 6).add(Aspect.ELDRITCH, 4).add(Aspect.VOID, 2));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_GENERAL), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.VOID, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_ARCANE), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 8));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_WATER), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.WATER, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_FIRE), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.FIRE, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_EARTH), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.EARTH, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_AIR), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.AIR, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_LIGHTNING), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.ENERGY, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_ICE), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.SLIME, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_NATURE), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.PLANT, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_LIFE), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.AURA, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.bookAffinity, 1, ItemAffinityBook.META_ENDER), new AspectList().add(Aspect.MIND, 4).add(Aspect.MAGIC, 4).add(Aspect.ELDRITCH, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_ARCANE), new AspectList().add(Aspect.MAGIC, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_EARTH), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.EARTH, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_AIR), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.AIR, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_FIRE), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.FIRE, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_WATER), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.WATER, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_NATURE), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.PLANT, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_ICE), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.SLIME, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_LIGHTNING), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.ENERGY, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_LIFE), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.AURA, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_ENDER), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.ELDRITCH, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_PURE), new AspectList().add(Aspect.ORDER, 10).add(Aspect.ELDRITCH, 5).add(Aspect.AURA, 5).add(Aspect.EARTH, 2).add(Aspect.AIR, 2).add(Aspect.FIRE, 2).add(Aspect.WATER, 2).add(Aspect.PLANT, 2).add(Aspect.SLIME, 2).add(Aspect.ENERGY, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_HIGH_CORE), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.ENERGY, 2).add(Aspect.PLANT, 2).add(Aspect.SLIME, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_BASE_CORE), new AspectList().add(Aspect.MAGIC, 9).add(Aspect.AIR, 2).add(Aspect.FIRE, 2).add(Aspect.EARTH, 2).add(Aspect.WATER, 2));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_BLANK), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_BLUE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_BLACK), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_BROWN), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_CYAN), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_GRAY), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_GREEN), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_LIGHTBLUE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_LIGHTGRAY), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_LIME), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_MAGENTA), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_ORANGE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_PINK), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_PURPLE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_RED), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_WHITE), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_YELLOW), new AspectList().add(Aspect.EARTH, 1).add(Aspect.MAGIC, 1).add(Aspect.SENSES, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_INF_ORB_BLUE), new AspectList().add(Aspect.MIND, 5).add(Aspect.MAGIC, 5));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_INF_ORB_GREEN), new AspectList().add(Aspect.MIND, 5).add(Aspect.MAGIC, 10));
		ThaumcraftApi.registerObjectTag(new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_INF_ORB_RED), new AspectList().add(Aspect.MIND, 5).add(Aspect.MAGIC, 15));
